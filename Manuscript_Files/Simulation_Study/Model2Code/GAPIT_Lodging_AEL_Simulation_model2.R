...
setwd("C:/Users/shensto2/Desktop/Simulation_Study/Experiment_Setting_6/Model_2_Results")
...
mydataPath="C:/Users/shensto2/Desktop/Simulation_Study/Experiment_Setting_6/intercepts/1_Add_QTN1_Epi_QTN_h.2__add.eff_0.9_epis.eff_0_reps_100_sim_6_int1/"

#Phenotypic Data
myY  <- read.table(paste(mydataPath,"Simulated.Data.100.Reps.Herit.100.55K.Names.AEL.txt",sep=""), head = TRUE)
head(myY)
dim(myY)
...
group.from=281,			#my file had 97 obersvations, since I don't want to do any sort of compression i set both groups to 97
group.to=281,			#Upper bound for number of group
